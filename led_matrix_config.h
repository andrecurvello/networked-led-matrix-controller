...
#define CLK_OUT_PORT		GPIO_PORTA_AHB_BASE
#define CLK_OUT_PIN		GPIO_PIN_4

#define LATCH_PORT		GPIO_PORTA_AHB_BASE
#define LATCH_PIN		GPIO_PIN_3

#define SER_OUT_PORT		GPIO_PORTA_AHB_BASE
#define SER_OUT_PIN		GPIO_PIN_2

#define ROW_SER_OUT_PORT	GPIO_PORTD_AHB_BASE
#define ROW_SER_OUT_PIN		GPIO_PIN_6

#define ROW_CLK_OUT_PORT	GPIO_PORTC_AHB_BASE
#define ROW_CLK_OUT_PIN		GPIO_PIN_5

#define ROW_LATCH_PORT		GPIO_PORTC_AHB_BASE
#define ROW_LATCH_PIN		GPIO_PIN_7

#define ROW_ENABLE_PORT		GPIO_PORTC_AHB_BASE
